...
module.exports = defineConfig({
  ...
  projects: [
    ...
    {
      name: 'chromium',
      use: { ...devices['Desktop Chrome'], storageState: AUTH_FILE, args: ['--start-maximized'] },
      dependencies: ['setup'],
    },
    {
      name: 'firefox',
      use: { ...devices['Desktop Firefox'], storageState: AUTH_FILE, args: ['--start-maximized'] },
      dependencies: ['setup'],
    },
    {
      name: 'webkit',
      use: { ...devices['Desktop Safari'], storageState: AUTH_FILE, args: ['--start-maximized'] },
      dependencies: ['setup'],
    },
  ],
